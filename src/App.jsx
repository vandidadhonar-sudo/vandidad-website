    ...
    <div style={{ background:'#050A1E', color:'#F1F5F9', overflowX:'hidden' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth:'1280px', margin:'0 auto',
          ...
          <div dir="ltr" style={{ fontSize:'13px', fontWeight:900,
            letterSpacing:'0.15em', textTransform:'uppercase',
            background:'linear-gradient(90deg,#00F2FE,#818CF8,#A855F7)',
          ...
          <div dir="ltr" style={{ display:'flex', gap:'20px' }}>
            {['fa','en','tr','ar'].map((l) => (
              <button key={l} onClick={() => setLang(l)} style={{
                ...
                color: lang===l ? '#00F2FE' : 'rgba(255,255,255,0.35)',
                fontWeight: lang===l ? 700 : 400,
                textShadow: lang===l ? '0 0 12px rgba(0,242,254,0.8)' : 'none',
                transition:'all 0.3s',
              }}>

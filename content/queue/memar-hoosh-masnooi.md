...
اما همین عبارت معنای دیگری هم دارد که در فارسی تقریباً بی‌صاحب مانده. در نرم‌افزار، معمار کسی است که پیش از نوشتن کد تصمیم می‌گیرد سیستم چطور ساخته شود. این نوشته دربارهٔ همان معنای دوم است.
...
چون خصوصیت مشترکشان همان چیزی است که معماری ساختمان را از ساخت‌وساز جدا می‌کند: هر چهار تصمیم پیش از شروع گرفته می‌شوند و بعداً تغییرشان گران است.

...
اینکه چنین سیستمی تا کجا باید اختیار داشته باشد و کجا باید بایستد، در نوشتهٔ [هوش مصنوعی عاملی چیست و کجا نباید به آن اختیار داد](https://vandidad.xyz/hamzad/hoosh-masnooi-ameli-chist) آمده است.

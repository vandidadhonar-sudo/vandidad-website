...
answer: >-
  اتوماسیون پاسخگویی به مشتری وقتی شکست می‌خورد که مرزش را بر حسب «موضوع»
  بکشیم — ارسال و مرجوعی با ربات، فنی با آدم. مشتری موضوع‌بندی نمی‌کند و
  یک پیام چند موضوع دارد. مرزِ درست بر حسب ریسک است: هرچه اشتباهش برگشت‌پذیر
  باشد خودکار شود، و هرچه پول یا تعهد در آن هست به آدم برسد.
...
اینکه چطور باید حد اختیار چنین سیستمی را تعیین کرد، در نوشتهٔ [هوش مصنوعی عاملی چیست و کجا نباید به آن اختیار داد](https://vandidad.xyz/hamzad/hoosh-masnooi-ameli-chist) آمده است، و [چرا چت‌بات برای کسب‌وکار جواب نداد](/hamzad/chatbot-vs-digital-twin) نشان می‌دهد چرا مرزِ موضوعی از اول شکستنی بود.

...
اگر می‌خواهید ببینید همین دقت در انتخاب واژه در کارِ فنی چه شکلی می‌شود، [سیستم‌عامل هوش مصنوعی چیست](/hamzad/sistem-amel-hoosh-masnooi-chist) سه اصطلاحی را که معمولاً یکی گرفته می‌شوند از هم جدا می‌کند. و اگر خواستید بدانید چه کسی این را می‌نویسد و بر چه اساسی، [پروندهٔ هادی بخت‌زاده](/hadi-bakhtzadeh) — معمار سیستم‌های هوش مصنوعی و بنیان‌گذار وندیداد گروپ — با شمارهٔ ثبت و راه استعلامش آنجاست، و [سه سیستمی که ساخته](/mahsoolat) با عدد.
